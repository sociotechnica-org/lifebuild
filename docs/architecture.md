...
const schema = {
  tables: {
    ...
    tasks: { id: 'string', boardId: 'string', columnId: 'string', title: 'string', position: 'number' },
    ...
    // Background Jobs
    workerTasks: { id: 'string', workerId: 'string', type: 'string', status: 'string', payload: 'json' }
  }
}
```
