...
- Manual update of local __livestore_sync_status.head to 683 did not resolve because backend head advanced further before boot.
...
3) Inspect __livestore_sync_status:
   - eventlog@6.db -> head
