...
A conceptual framework organizing work into three fundamentally different streams: **[[gold-slot|Gold]]** (transformation), **[[silver-slot|Silver]]** (leverage), and **[[bronze-stack|Bronze]]** (operations). Each stream serves a different purpose and requires different energy. The model helps directors consciously balance across work types rather than defaulting to whatever feels urgent.
...
The Three-Stream Model makes these categories explicit, manifested visually in [[the-table]].
...
Making work types visually distinct ([[gold-slot]] glow, [[silver-slot]] glow, [[bronze-stack]] stack) reinforces that different work deserves different treatment. Directors see their portfolio balance at a glance.

**Driver:** Observed pattern
Directors without explicit stream thinking consistently over-indexed on operational work ([[bronze-stack|Bronze]]) because it felt productive and urgent. Important-but-not-urgent work ([[gold-slot|Gold]], [[silver-slot|Silver]]) got perpetually deferred.
...
- Archetype: Quick Task | Scale: Micro
...
- [[the-table]] — three positions ([[gold-slot]], [[silver-slot]], [[bronze-stack]]) implement this model
- [[priority-queue]] — filters (Gold Candidates, Silver Candidates, Bronze Candidates) organize by stream
- [[sorting-room]] — selection process walks through each stream separately
...
- [ ] How do Critical Response projects fit? (Currently classified by scale)
- [ ] Should stream history be visible? ("You've had empty [[gold-slot|Gold]] for 3 weeks")
