...
- **Dismissal/snooze state**: Whether a builder has dismissed or snoozed a specific signal
...
- Builders can dismiss or snooze individual signals
...
- **Sending a push notification to the builder's phone when a smoke signal triggers** — Smoke Signals are explicitly ambient and visual. They appear on the Life Map when the builder looks. Converting them to push alerts violates the "ambient, not interruptive" design principle and turns helpful awareness into nagging.
