...
- Parent:
  - [[Structure - Hex Grid]] — lives on the hex grid as the origin tile
- Conforms to:
  - [[Standard - Visual Language]] — warm glow, visual aesthetic per spec
  - [[Standard - Onboarding Sequence]] — Day 1 warm greeting and spatial orientation
- Related:
  - [[Component - Hex Tile]] — sibling component on the hex grid
  - [[System - Clustering]] — first clusters form around Campfire
