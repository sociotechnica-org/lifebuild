...
- Parent:
  - [[Overlay - The Table]] — center position on the persistent priority overlay
- Conforms to:
  - [[Standard - Three-Stream Portfolio]] — Silver stream slot constraints
  - [[Standard - Visual Language]] — cool silver/platinum color accent
  - [[Standard - Table Slot Behaviors]] — empty Silver visual treatment per spec
- Related:
