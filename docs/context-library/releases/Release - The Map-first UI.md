...
- [ ] Marvin is always available via Attendant Rail when working on projects
...
- Attendant Rail is hidden, Task Queue is hidden
...
- Attendant Rail fades in with Jarvis and Marvin avatars
...
- Work with Marvin on any project — he's always present in the Attendant Rail
...
- Chat with Jarvis or Marvin from any context via the Attendant Rail
...
**Who falls in love here:** Someone overwhelmed by their life who wants to _see_ it laid out in front of them — and who responds to the warmth of guided AI conversations rather than blank-slate productivity apps. The "I've tried everything and nothing sticks" person.
