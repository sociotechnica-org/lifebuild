...
"I built that. The sanctuary grew because of what I did."

## WHERE: Moments

- Contexts:
  - [[Zone - Life Map]] — hex tile transformation on project completion
...
- Anticlimactic completion — finishing a project and nothing visible changes. The map must react.
- Invisible systems — planting a system that doesn't appear on the map or generate visible task flow
- Achievement pop-ups or score increments — extrinsic reward mechanics cheapen genuine accomplishment. The map IS the reward.
- Delayed visual feedback — if tile evolution happens on a schedule rather than tied to completion, the accomplishment-to-feedback link breaks
- Dismissive steward responses — if Marvin says "OK, marked done. What's next?" without acknowledging the achievement, Accomplishment is undermined

### Examples

**Example 1:** Completing a Gold project

- Context: Builder finishes their first aspirational Gold venture: "Write conference proposal"
...
- **Points or XP for completing projects** — the tile evolution IS the reward. Adding numbers on top converts intrinsic accomplishment into extrinsic reward-seeking.
- **Leaderboards comparing builder progress** — accomplishment is personal. "You completed 3 projects this month" is fine. "You're in the top 10% of builders" is toxic.
- **"Earn your fun" gating** — accomplishment should never be a prerequisite for access to features or rest. The builder rests when they need to, builds when they choose to.
