...
- **PR gate check:** Flag any MAKE or PATCH item at QC Gate or Review without a linked PR — **on both Board #4 and Board #5** (D9, #654). Per the PR gate protocol (`.claude/skills/george/board-fields.md`), these stations require a PR as the review artifact. An item at Review with no PR means the gate was skipped.
