...
const CampfireRevealPrototype = lazy(async () => ({
  default: (await import('./prototypes/CampfireRevealPrototype.js')).CampfireRevealPrototype,
}))
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        />
        <Route
          path='/campfire-reveal'
          element={
            <Suspense fallback={<RouteLoadingFallback />}>
              <CampfireRevealPrototype />
            </Suspense>
          }
        />
