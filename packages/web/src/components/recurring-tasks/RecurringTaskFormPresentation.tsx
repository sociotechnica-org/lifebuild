...
export const RecurringTaskFormPresentation: React.FC<RecurringTaskFormPresentationProps> = ({
  isOpen,
  onClose,
  onSubmit,
  projects,
      ...
      >
        <form onSubmit={handleSubmit}>
          <div className="flex items-center justify-between p-6 border-b border-gray-200">
            <h1 id="create-recurring-task-modal-title" className="text-lg font-semibold text-gray-900">
          ...
          <div className="p-6 space-y-4">
            <div>
              <label htmlFor="recurring-task-name" className="block text-sm font-medium text-gray-900 mb-2">
                Name *
              </label>
              <input
            ...
            <div>
              <label htmlFor="recurring-task-description" className="block text-sm font-medium text-gray-900 mb-2">
                Description
              </label>
              <textarea
            ...
            <div>
              <label htmlFor="recurring-task-prompt" className="block text-sm font-medium text-gray-900 mb-2">
                Prompt *
              </label>
              <textarea
            ...
            <div>
              <label htmlFor="recurring-task-interval" className="block text-sm font-medium text-gray-900 mb-2">
                Run Every
              </label>
              <select
            ...
            <div>
              <label htmlFor="recurring-task-project" className="block text-sm font-medium text-gray-900 mb-2">
                Project
              </label>
              <select
              ...
              <p className="text-xs text-gray-500 mt-1">
                If selected, the AI will have access to this project's context when running the task.
              </p>
            </div>
          </div>
