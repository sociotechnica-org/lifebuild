...
export const PROJECT_CATEGORIES = [
  {
    ...
    shortDescription: 'Body, mind, and wellbeing',
    colorHex: '#10B981',
    icon: '🧘‍♀️',
    sortOrder: 1,
  },
  {
    ...
    shortDescription: 'Bonds with family and friends',
    colorHex: '#EC4899',
    icon: '💗',
    sortOrder: 2,
  },
  {
    ...
    shortDescription: 'Managing and growing your money',
    colorHex: '#3B82F6',
    icon: '💰',
    sortOrder: 3,
  },
  {
    ...
    shortDescription: 'Skills, knowledge, personal growth',
    colorHex: '#8B5CF6',
    icon: '🧠',
    sortOrder: 4,
  },
  {
    ...
    shortDescription: 'Travel, hobbies, and play',
    colorHex: '#F59E0B',
    icon: '🌴',
    sortOrder: 5,
  },
  {
    ...
    shortDescription: 'Philosophy, spirituality, meaning',
    colorHex: '#6366F1',
    icon: '🔮',
    sortOrder: 6,
  },
  {
    ...
    shortDescription: 'Your living space and environment',
    colorHex: '#14B8A6',
    icon: '🏡',
    sortOrder: 7,
  },
  {
    ...
    shortDescription: 'Giving back to others',
    colorHex: '#EF4444',
    icon: '🌍',
    sortOrder: 8,
  },
