...
import { verifyJWT, isTokenExpired, isWithinGracePeriod, decodeJWTPayload, getUserIdFromToken } from '../../src/auth/jwt.js'

// Mock JWT for testing (this would be generated by auth service in reality)
const createMockJWT = (payload: any, secret: string = 'test-secret'): Promise<string> => {
